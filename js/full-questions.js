const originalQuestions = [
  ...
  },
  {
    ...
    tip: "Hạng D2: trên 16 chỗ đến 29 chỗ (không kể lái xe); và lái xe hạng B, C1, C, D1;",
    answers: [
      {
        id: 1,
  ...
  },
  {
    ...
    tip: "Biển số R.412 (a,b,c,d,e,f,g,h) 'Làn đường dành riêng cho từng loại xe hoặc nhóm xe': Khi đến gần nơi đường bộ giao nhau, xe được phép chuyển làn để đi theo hành trình mong muốn. Việc chuyển làn phải thực hiện theo đúng các quy định.",
    answers: [
      {
        id: 1,
...
var licenseType = "B_2025";

// Get required questions filter - returns questions with required flag for given license
var getRequiredFilter = function (code) {
  if (code === "A1_2025" || code === "A_2025") {
    return function (q) {
      return q.required1 > 0;
    };
  } else if (code === "B1_2025") {
    return function (q) {
      return q.required2 > 0;
    };
  } else {
    return function (q) {
      return q.required3 > 0;
    };
  }
};

var fullQuestions = originalQuestions;
var filterRequiredFunction = getRequiredFilter(licenseType);
