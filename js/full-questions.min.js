const originalQuestions = [
  {
    ...
    answers: [
      { id: 1, text: "Phần mặt đường và lề đường.", correct: !1 },
      { id: 2, text: "Phần đường xe chạy.", correct: !0 },
      { id: 3, text: "Phần đường xe cơ giới.", correct: !1 },
    ],
    topic: 1,
    a1: 1,
    a2: 1,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 4, text: "Cả ba ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 5,
    a2: 5,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 6,
    a2: 6,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Là người điều khiển xe cơ giới.", correct: !0 },
      { id: 2, text: "Là người điều khiển xe thô sơ.", correct: !1 },
      { id: 3, text: "Là người điều khiển xe máy chuyên dùng.", correct: !1 },
    ],
    topic: 1,
    a1: 7,
    a2: 7,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Phương tiện giao thông cơ giới đường bộ.", correct: !1 },
      {
        id: 2,
        text: "Phương tiện giao thông thô sơ đường bộ, xe máy chuyên dùng và các loại xe tương tự.",
        correct: !1,
      },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 10,
    a2: 10,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Người điều khiển xe máy chuyên dùng.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 12,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Là người tham gia giao thông đường bộ.", correct: !1 },
    ],
    topic: 1,
    a1: 13,
    a2: 13,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Sử dụng xe đạp đi trên các tuyến quốc lộ.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Hết niên hạn sử dụng.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 15,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Trên đường phố không có người qua lại.", correct: !1 },
      { id: 2, text: "Được người dân ủng hộ.", correct: !1 },
      { id: 3, text: "Được cơ quan có thẩm quyền cấp phép.", correct: !0 },
    ],
    topic: 1,
    a1: 16,
    a2: 16,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ bị nhắc nhở.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Bị phạt tiền.", correct: !1 },
      { id: 2, text: "Bị tước giấy phép lái xe.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Bị nghiêm cấm.", correct: !0 },
      { id: 2, text: "Không bị nghiêm cấm.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Bị phạt tiền.", correct: !1 },
      { id: 2, text: "Có thể bị tước giấy phép lái xe.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Người được chở trên xe cơ giới.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 19,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Người chưa đủ tuổi theo quy định.", correct: !1 },
      { id: 2, text: "Người không có giấy phép lái xe.", correct: !1 },
      {
        id: 3,
        text: "Người có giấy phép lái xe nhưng đã bị trừ hết 12 điểm.",
        correct: !1,
      },
      { id: 4, text: "Cả ba ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 20,
    a2: 20,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không bị nghiêm cấm.", correct: !1 },
      { id: 2, text: "Bị nghiêm cấm.", correct: !0 },
      { id: 3, text: "Bị nghiêm cấm tùy trường hợp.", correct: !1 },
    ],
    topic: 1,
    a1: 24,
    a2: 24,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Thay đổi tốc độ của xe nhiều lần.", correct: !1 },
      {
        id: 2,
        text: "Điều khiển phương tiện sau 23 giờ trong ngày.",
        correct: !1,
      },
      { id: 3, text: "Lạng lách, đánh võng, rú ga liên tục.", correct: !0 },
    ],
    topic: 1,
    a1: 25,
    a2: 25,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Theo tín hiệu đèn giao thông.", correct: !1 },
      { id: 3, text: "Theo biển báo hiệu đường bộ.", correct: !1 },
    ],
    topic: 1,
    a1: 31,
    a2: 31,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển báo hiệu đặt cố định.", correct: !1 },
      { id: 2, text: "Biển báo hiệu tạm thời.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Không vượt quá tốc độ tối đa cho phép.", correct: !0 },
    ],
    topic: 1,
    a1: 34,
    a2: 34,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đi về bên trái theo chiều đi của mình.", correct: !1 },
      { id: 2, text: "Đi về bên phải theo chiều đi của mình.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đi trên làn đường bên phải trong cùng.", correct: !1 },
      { id: 2, text: "Đi trên làn đường bên trái.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Khi phía trước có xe chạy ngược chiều.", correct: !1 },
      {
        id: 3,
        text: "Khi xe sau xin vượt nếu đủ điều kiện an toàn.",
        correct: !0,
      },
      { id: 4, text: "Khi xe sau có tín hiệu vượt bên phải.", correct: !1 },
    ],
    topic: 1,
    a1: 37,
    a2: 37,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được phép vượt khi đường vắng.", correct: !1 },
      { id: 2, text: "Không được phép vượt.", correct: !0 },
      { id: 3, text: "Được phép vượt khi có việc gấp.", correct: !1 },
    ],
    topic: 1,
    a1: 39,
    a2: 39,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Từ 05 giờ đến 22 giờ.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ bật đèn chiếu xa (đèn pha).", correct: !1 },
      {
        id: 2,
        text: "Bật đèn chiếu xa (đèn pha) khi đường vắng, bật đèn chiếu gần (đèn cốt) khi có xe đi ngược chiều.",
        correct: !1,
      },
      { id: 3, text: "Chỉ bật đèn chiếu gần (đèn cốt).", correct: !0 },
    ],
    topic: 1,
    a1: 42,
    a2: 42,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Trên cầu có từ 02 làn xe trở lên.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Giảm tốc độ và có tín hiệu báo hướng rẽ.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Khi bắt đầu chuyển làn đường.", correct: !1 },
      { id: 2, text: "Trước khi thay đổi làn đường.", correct: !0 },
      { id: 3, text: "Sau khi thay đổi làn đường.", correct: !1 },
    ],
    topic: 1,
    a1: 47,
    a2: 47,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Trong phạm vi an toàn của đường sắt.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 48,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "0,25 mét.", correct: !0 },
      { id: 2, text: "0,3 mét.", correct: !1 },
      { id: 3, text: "0,4 mét.", correct: !1 },
      { id: 4, text: "0,5 mét.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "10 mét.", correct: !1 },
      { id: 2, text: "15 mét.", correct: !1 },
      { id: 3, text: "20 mét.", correct: !0 },
      { id: 4, text: "25 mét.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được phép.", correct: !1 },
      {
        id: 2,
        text: "Nếu phương tiện được kéo, đẩy có khối lượng nhỏ hơn phương tiện của mình.",
        correct: !1,
      },
      { id: 3, text: "Tùy trường hợp.", correct: !1 },
      { id: 4, text: "Không được phép.", correct: !0 },
    ],
    topic: 1,
    a1: 49,
    a2: 49,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 4, text: "Chở người ngồi sau dưới 16 tuổi.", correct: !1 },
    ],
    topic: 1,
    a1: 51,
    a2: 51,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Mang, vác vật cồng kềnh.", correct: !1 },
      { id: 2, text: "Bám, kéo hoặc đẩy các phương tiện khác.", correct: !1 },
      {
        id: 3,
        text: "Dùng tay cầm điện thoại hoặc các thiết bị điện tử khác.",
        correct: !1,
      },
      { id: 4, text: "Ý 1 và ý 2.", correct: !0 },
    ],
    topic: 1,
    a1: 52,
    a2: 52,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đi xe dàn hàng ngang; buông cả hai tay.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được sử dụng.", correct: !1 },
      { id: 2, text: "Chỉ người ngồi sau được sử dụng.", correct: !1 },
      { id: 3, text: "Không được sử dụng.", correct: !0 },
      { id: 4, text: "Được sử dụng nếu không có áo mưa.", correct: !1 },
    ],
    topic: 1,
    a1: 59,
    a2: 59,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ được phép nếu cả hai đội mũ bảo hiểm.", correct: !1 },
      { id: 2, text: "Không được phép.", correct: !0 },
      { id: 3, text: "Chỉ được thực hiện trên đường vắng.", correct: !1 },
    ],
    topic: 1,
    a1: 60,
    a2: 60,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không bị xử phạt chỉ bị nhắc nhở.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ được báo hiệu bằng còi.", correct: !1 },
      { id: 2, text: "Phải báo hiệu bằng cả còi và đèn.", correct: !1 },
      { id: 3, text: "Chỉ được báo hiệu bằng đèn.", correct: !0 },
    ],
    topic: 1,
    a1: 64,
    a2: 64,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Phải lùi thật chậm.", correct: !1 },
      { id: 2, text: "Bấm còi 3 lần liên tiếp trước khi lùi.", correct: !1 },
      { id: 3, text: "Không được lùi xe.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Nhường đường cho xe lên dốc.", correct: !0 },
      { id: 3, text: "Chỉ nhường đường khi xe lên dốc nháy đèn.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Nhường đường cho xe đi đến từ bên phải.", correct: !1 },
      { id: 2, text: "Nhường đường cho xe đi đến từ bên trái.", correct: !0 },
      { id: 3, text: "Không phải nhường đường.", correct: !1 },
    ],
    topic: 1,
    a1: 70,
    a2: 70,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không bị hạn chế tốc độ.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không được vượt.", correct: !1 },
      {
        id: 2,
        text: "Được phép vượt ở phần đường dành cho người đi bộ qua đường.",
        correct: !1,
      },
      { id: 3, text: "Được vượt khi bảo đảm an toàn.", correct: !0 },
    ],
    topic: 1,
    a1: 74,
    a2: 74,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không được vượt.", correct: !0 },
      { id: 2, text: "Được vượt khi đang đi trên cầu.", correct: !1 },
      {
        id: 3,
        text: "Được phép vượt khi đi qua nơi giao nhau có ít phương tiện cùng tham gia giao thông.",
        correct: !1,
      },
      { id: 4, text: "Được vượt khi bảo đảm an toàn.", correct: !1 },
    ],
    topic: 1,
    a1: 75,
    a2: 75,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hiệu lệnh của nhân viên gác chắn.", correct: !1 },
      { id: 2, text: "Đèn đỏ sáng nhấp nháy, chuông kêu.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Nối bằng dây cáp có độ dài 6 mét.", correct: !1 },
      { id: 2, text: "Nối bằng dây cáp có độ dài 8 mét.", correct: !1 },
      { id: 3, text: "Nối bằng thanh nối cứng.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Lùi xe, quay đầu xe.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Tiếp tục lái xe và rẽ ở lối ra tiếp theo.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Có.", correct: !1 },
      { id: 2, text: "Không.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "18 tuổi.", correct: !0 },
      { id: 2, text: "17 tuổi.", correct: !1 },
      { id: 3, text: "16 tuổi.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "16 tuổi.", correct: !1 },
      { id: 2, text: "17 tuổi.", correct: !1 },
      { id: 3, text: "18 tuổi.", correct: !0 },
    ],
    topic: 1,
    a1: 84,
    a2: 84,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "23 tuổi.", correct: !1 },
      { id: 2, text: "24 tuổi.", correct: !1 },
      { id: 3, text: "27 tuổi.", correct: !0 },
      { id: 4, text: "30 tuổi.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Đủ 55 tuổi đối với nam và nữ.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "23 tuổi.", correct: !1 },
      { id: 2, text: "24 tuổi.", correct: !0 },
      { id: 3, text: "22 tuổi.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Xe gắn máy.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Xe mô tô ba bánh.", correct: !0 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 86,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Xe mô tô ba bánh.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 87,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Phải mang theo giấy phép xe tập lái.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Phải là người đứng tên trong đăng ký xe.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 89,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Giấy phép lái xe được cấp sai quy định.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không được phục hồi.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Tiếp tục chịu trách nhiệm của chủ xe.", correct: !0 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe ô tô kinh doanh vận tải.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "50 km/h.", correct: !1 },
      { id: 2, text: "40 km/h.", correct: !0 },
      { id: 3, text: "60 km/h.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "60 km/h.", correct: !0 },
      { id: 2, text: "50 km/h.", correct: !1 },
      { id: 3, text: "40 km/h.", correct: !1 },
    ],
    topic: 1,
    a1: 94,
    a2: 94,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "60 km/h.", correct: !1 },
      { id: 2, text: "50 km/h.", correct: !0 },
      { id: 3, text: "40 km/h.", correct: !1 },
    ],
    topic: 1,
    a1: 95,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Xe gắn máy, xe máy chuyên dùng.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "35 m.", correct: !1 },
      { id: 2, text: "55 m.", correct: !1 },
      { id: 3, text: "70 m.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    tip: "Khoảng cách an toàn tối thiểu: 60km/h = 35m; 60 - 80km/h = 55m; 80 - 100km/h = 70m; 100 - 120km/h = 100m.",
    answers: [
      { id: 1, text: "55 m.", correct: !1 },
      { id: 2, text: "70 m.", correct: !1 },
      { id: 3, text: "100 m.", correct: !0 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    tip: "Khoảng cách an toàn tối thiểu: 60km/h = 35m; 60 - 80km/h = 55m; 80 - 100km/h = 70m; 100 - 120km/h = 100m.",
    answers: [
      { id: 1, text: "55 m.", correct: !0 },
      { id: 2, text: "70 m.", correct: !1 },
      { id: 3, text: "100 m.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    tip: "Khoảng cách an toàn tối thiểu: 60km/h = 35m; 60 - 80km/h = 55m; 80 - 100km/h = 70m; 100 - 120km/h = 100m.",
    answers: [
      { id: 1, text: "35 m.", correct: !0 },
      { id: 2, text: "55 m.", correct: !1 },
      { id: 3, text: "70 m.", correct: !1 },
    ],
    topic: 1,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Gặp biển chỉ dẫn trên đường.", correct: !1 },
      { id: 3, text: "Gặp biển báo hết mọi lệnh cấm.", correct: !1 },
      {
        id: 4,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cạnh tranh nhau nhằm tăng lợi nhuận.", correct: !1 },
      { id: 2, text: "Giảm giá để thu hút khách.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không quá 4 giờ.", correct: !0 },
      { id: 2, text: "Không quá 6 giờ.", correct: !1 },
      { id: 3, text: "Không quá 8 giờ.", correct: !1 },
      {
        id: 4,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không quá 6 giờ trong một ngày.", correct: !1 },
      { id: 2, text: "Không quá 8 giờ trong một ngày.", correct: !1 },
      { id: 3, text: "Không quá 10 giờ trong một ngày.", correct: !0 },
      {
        id: 4,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Được cộng điểm vào giấy phép lái xe.", correct: !1 },
      { id: 3, text: "Cả hai ý trên.", correct: !1 },
    ],
    topic: 2,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 4, text: "Tránh nhường đường để đi nhanh hơn.", correct: !1 },
    ],
    topic: 2,
    a1: 101,
    a2: 101,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cho xe chạy thật nhanh qua vũng nước.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Là thiếu văn hóa giao thông.", correct: !1 },
    ],
    topic: 2,
    a1: 103,
    a2: 103,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Thực hiện cầm máu trực tiếp.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Thực hiện các biện pháp hô hấp nhân tạo.", correct: !1 },
    ],
    topic: 2,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không bị nghiêm cấm.", correct: !1 },
      { id: 2, text: "Nghiêm cấm tùy từng trường hợp cụ thể.", correct: !1 },
      { id: 3, text: "Bị nghiêm cấm.", correct: !0 },
    ],
    topic: 2,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Bấm còi để họ đi nhanh hơn.", correct: !1 },
      { id: 3, text: "Tiếp tục đi nếu đang vội.", correct: !1 },
      { id: 4, text: "Vượt qua nếu thấy khoảng trống đủ rộng.", correct: !1 },
    ],
    topic: 2,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chạy đi để tránh rắc rối.", correct: !1 },
      {
        id: 2,
        text: "Dừng xe, hỗ trợ nạn nhân và báo cho cơ quan chức năng.",
        correct: !0,
      },
      { id: 3, text: "Chỉ quan sát rồi tiếp tục di chuyển.", correct: !1 },
      {
        id: 4,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 4, text: "Ý 1 và ý 3.", correct: !0 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đang sử dụng phanh đỗ.", correct: !0 },
      { id: 2, text: "Nhiệt độ nước làm mát quá mức cho phép.", correct: !1 },
      { id: 3, text: "Cửa xe đang mở.", correct: !1 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đang sử dụng phanh đỗ.", correct: !1 },
      { id: 2, text: "Thiếu dầu phanh.", correct: !1 },
      {
        id: 3,
        text: "Nhiệt độ nước làm mát tăng quá mức cho phép.",
        correct: !1,
      },
      { id: 4, text: "Áp suất dầu ở mức thấp.", correct: !0 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Bộ nạp ắc quy gặp sự cố kỹ thuật.", correct: !1 },
      { id: 3, text: "Dầu bôi trơn bị thiếu.", correct: !1 },
      { id: 4, text: "Ý 2 và ý 3.", correct: !1 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Thiếu dầu phanh, phanh tay đang hãm.", correct: !1 },
      { id: 2, text: "Hệ thống túi khí an toàn gặp sự cố.", correct: !1 },
      {
        id: 3,
        text: "Lái xe và người ngồi ghế trước chưa cài dây đai an toàn.",
        correct: !0,
      },
      { id: 4, text: "Cửa đóng chưa chặt, có cửa chưa đóng.", correct: !1 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo hiệu thiếu dầu phanh.", correct: !1 },
      { id: 2, text: "Áp suất lốp không đủ.", correct: !1 },
      { id: 3, text: "Đang sử dụng phanh đỗ.", correct: !1 },
      { id: 4, text: "Sắp hết nhiên liệu.", correct: !0 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xăng và dầu diesel.", correct: !1 },
      { id: 2, text: "Xăng sinh học và khí sinh học.", correct: !0 },
      { id: 3, text: "Ý 1 và ý 2.", correct: !1 },
    ],
    topic: 3,
    a1: 114,
    a2: 114,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không đúng.", correct: !1 },
      { id: 2, text: "Đúng.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Vị trí N hoặc vị trí P hoặc số 0.", correct: !0 },
      { id: 2, text: "Vị trí D hoặc số 1.", correct: !1 },
      { id: 3, text: "Vị trí R.", correct: !1 },
    ],
    topic: 3,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Sử dụng phanh trước.", correct: !1 },
      { id: 2, text: "Sử dụng phanh sau.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Giảm tốc độ, về số thấp và giữ đều ga.", correct: !0 },
      { id: 2, text: "Tăng tốc độ cho xe lướt qua nhanh.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Sử dụng còi.", correct: !1 },
      {
        id: 2,
        text: "Phanh đồng thời cả phanh trước và phanh sau.",
        correct: !1,
      },
      { id: 3, text: "Chỉ sử dụng phanh trước.", correct: !0 },
    ],
    topic: 3,
    a1: 120,
    a2: 120,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Để điều khiển xe chạy về phía trước.", correct: !1 },
      {
        id: 2,
        text: "Để điều tiết công suất động cơ qua đó điều khiển tốc độ của xe.",
        correct: !1,
      },
      { id: 3, text: "Để điều khiển xe chạy lùi.", correct: !1 },
      { id: 4, text: "Ý 1 và ý 2.", correct: !0 },
    ],
    topic: 3,
    a1: 122,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Tăng ga thật mạnh, giảm ga từ từ.", correct: !1 },
      { id: 2, text: "Tăng ga thật mạnh, giảm ga thật nhanh.", correct: !1 },
      { id: 3, text: "Tăng ga từ từ, giảm ga thật nhanh.", correct: !0 },
      { id: 4, text: "Tăng ga từ từ, giảm ga từ từ.", correct: !1 },
    ],
    topic: 3,
    a1: 124,
    a2: 124,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Nhả chân ga để phanh tái sinh hoạt động.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không bắt buộc.", correct: !1 },
      { id: 2, text: "Bắt buộc.", correct: !0 },
      { id: 3, text: "Tùy từng trường hợp.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đèn chiếu sáng gần và xa.", correct: !1 },
      {
        id: 2,
        text: "Đèn soi biển số, đèn báo hãm và đèn tín hiệu.",
        correct: !1,
      },
      { id: 3, text: "Dàn đèn pha trên nóc xe.", correct: !1 },
      { id: 4, text: "Ý 1 và ý 2.", correct: !0 },
    ],
    topic: 4,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "15 năm.", correct: !1 },
      { id: 2, text: "20 năm.", correct: !1 },
      { id: 3, text: "25 năm.", correct: !0 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "5 năm.", correct: !1 },
      { id: 2, text: "20 năm.", correct: !0 },
      { id: 3, text: "25 năm.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Áp suất lốp không đủ.", correct: !1 },
      { id: 3, text: "Đang hãm phanh tay.", correct: !1 },
      { id: 4, text: "Cần kiểm tra động cơ.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Áp suất lốp không đủ.", correct: !1 },
      { id: 3, text: "Đang hãm phanh tay.", correct: !1 },
      { id: 4, text: "Cần kiểm tra động cơ.", correct: !0 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo hiệu thiếu dầu phanh.", correct: !1 },
      { id: 2, text: "Áp suất lốp không đủ.", correct: !0 },
      { id: 3, text: "Đang hãm phanh tay.", correct: !1 },
      { id: 4, text: "Sắp hết nhiên liệu.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Không cần đạp phanh.", correct: !1 },
      { id: 3, text: "Tùy từng trường hợp.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Hỗ trợ người lái xe khởi hành ngang dốc.", correct: !1 },
      {
        id: 4,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 4, text: "Ý 2 và ý 3.", correct: !0 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Áp suất lốp không đủ.", correct: !1 },
      { id: 3, text: "Đang hãm phanh tay.", correct: !1 },
      { id: 4, text: "Hệ thống lái gặp sự cố.", correct: !0 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Dùng để kích (hay nâng) xe ô tô.", correct: !0 },
      { id: 2, text: "Vặn ốc lắp bánh xe.", correct: !1 },
      {
        id: 3,
        text: "Ổn định chuyển động của xe ô tô khi đi vào đường vòng.",
        correct: !1,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Thay lốp xe.", correct: !1 },
      { id: 2, text: "Chữa cháy.", correct: !1 },
      {
        id: 3,
        text: "Phá cửa kính xe ô tô trong các trường hợp khẩn cấp.",
        correct: !0,
      },
      { id: 4, text: "Vặn ốc để tháo lắp bánh xe.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Thay lốp xe.", correct: !1 },
      { id: 2, text: "Chữa cháy trong các trường hợp hỏa hoạn.", correct: !0 },
      { id: 3, text: "Cầm máu cho người bị nạn.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo hiệu xin đường cho xe đi thẳng.", correct: !1 },
      { id: 2, text: "Báo hiệu hệ thống phanh bị lỗi.", correct: !1 },
      { id: 3, text: "Báo hiệu xe đang ở tình huống nguy hiểm.", correct: !0 },
      { id: 4, text: "Báo hiệu đến thời gian cần bảo dưỡng.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo hiệu hệ thống túi khí đã bật.", correct: !1 },
      { id: 2, text: "Báo hiệu đèn chiếu sáng xa đã bật.", correct: !1 },
      {
        id: 3,
        text: "Báo hiệu chế độ lái tiết kiệm nhiên liệu đã bật.",
        correct: !0,
      },
      { id: 4, text: "Báo hiệu đèn cảnh báo khoảng cách đã bật.", correct: !1 },
    ],
    topic: 4,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !0 },
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Biển 1 và biển 3.", correct: !1 },
      { id: 4, text: "Cả ba biển.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả ba biển.", correct: !1 },
      { id: 2, text: "Biển 2 và biển 3.", correct: !1 },
      { id: 3, text: "Biển 1 và biển 3.", correct: !1 },
      { id: 4, text: "Biển 1 và biển 2.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 2 và biển 3.", correct: !0 },
      { id: 3, text: "Biển 1 và biển 3.", correct: !1 },
      { id: 4, text: "Cả ba biển.", correct: !1 },
    ],
    topic: 5,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1 và biển 2.", correct: !0 },
      { id: 2, text: "Biển 1 và biển 3.", correct: !1 },
      { id: 3, text: "Biển 2 và biển 3.", correct: !1 },
    ],
    topic: 5,
    a1: 127,
    a2: 127,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Cả hai biển.", correct: !0 },
    ],
    topic: 5,
    a1: 128,
    a2: 128,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không biển nào.", correct: !1 },
      { id: 2, text: "Biển 1 và biển 2.", correct: !1 },
      { id: 3, text: "Biển 2 và biển 3.", correct: !0 },
      { id: 4, text: "Cả ba biển.", correct: !1 },
    ],
    topic: 5,
    a1: 130,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1 và biển 2.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Biển 1 và biển 3.", correct: !0 },
      { id: 4, text: "Biển 2 và biển 3.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Biển 1 và biển 2.", correct: !1 },
      { id: 3, text: "Biển 1 và biển 3.", correct: !1 },
      { id: 4, text: "Biển 2 và biển 3.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !0 },
      { id: 3, text: "Không biển nào.", correct: !1 },
      { id: 4, text: "Cả hai biển.", correct: !1 },
    ],
    topic: 5,
    a1: 131,
    a2: 131,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !0 },
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Cả hai biển.", correct: !1 },
    ],
    topic: 5,
    a1: 132,
    a2: 132,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Biển 3.", correct: !1 },
      { id: 4, text: "Biển 1 và biển 3.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !0 },
      { id: 3, text: "Cả ba biển.", correct: !1 },
    ],
    topic: 5,
    a1: 139,
    a2: 139,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Biển 1 và biển 2.", correct: !0 },
    ],
    topic: 5,
    a1: 140,
    a2: 140,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 1 và biển 3.", correct: !0 },
      { id: 3, text: "Biển 2 và biển 3.", correct: !1 },
      { id: 4, text: "Biển 3.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đường cấm súc vật vận tải hàng hóa.", correct: !1 },
      { id: 2, text: "Đường cấm súc vật vận tải hành khách.", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Hạn chế khối lượng hàng hóa chở trên xe.", correct: !1 },
      { id: 3, text: "Hạn chế tải trọng trên trục xe.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được đi vào.", correct: !0 },
      { id: 2, text: "Không được đi vào.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Có.", correct: !0 },
      { id: 2, text: "Không.", correct: !1 },
    ],
    topic: 5,
    a1: 144,
    a2: 144,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Hướng trái và phải không cấm xe cơ giới.", correct: !1 },
    ],
    topic: 5,
    a1: 145,
    a2: 145,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo khoảng cách đến nơi cấm bóp còi.", correct: !1 },
      {
        id: 2,
        text: "Chiều dài đoạn đường cấm bóp còi từ nơi đặt biển.",
        correct: !0,
      },
      { id: 3, text: "Báo cấm dùng còi có độ vang xa 500m.", correct: !1 },
    ],
    topic: 5,
    a1: 146,
    a2: 146,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cấm các loại xe ở biển phụ đi vào.", correct: !0 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cấm dừng xe về hướng bên trái.", correct: !1 },
      { id: 2, text: "Cấm dừng và đỗ xe theo hướng bên phải.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    tip: "P.130 'Cấm dừng xe và đỗ xe', biển phụ chỉ hướng áp dụng. Cấm dừng và đỗ xe theo hướng bên phải.",
    answers: [
      { id: 1, text: "Không được phép.", correct: !0 },
      { id: 2, text: "Được phép.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cấm ô tô buýt.", correct: !1 },
      { id: 2, text: "Cấm xe ô tô khách.", correct: !0 },
      { id: 3, text: "Cấm xe ô tô con.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hạn chế chiều cao của xe và hàng.", correct: !1 },
      { id: 2, text: "Hạn chế chiều ngang của xe và hàng.", correct: !0 },
      { id: 3, text: "Hạn chế chiều dài của xe và hàng.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Biển 1 và biển 2.", correct: !1 },
      { id: 3, text: "Biển 2 và biển 3.", correct: !1 },
      { id: 4, text: "Cả ba biển.", correct: !0 },
    ],
    topic: 5,
    a1: 159,
    a2: 159,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Nơi đường sắt giao nhau với đường bộ.", correct: !1 },
    ],
    topic: 5,
    a1: 166,
    a2: 166,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Nơi đường sắt giao nhau với đường bộ.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    tip: "Biển 1: W.207a 'Giao nhau với đường không ưu tiên';<br/>Biển 2: W.208 'Giao nhau với đường ưu tiên';<br/>Biển 3: I.401 'Bắt đầu đường ưu tiên'.",
    answers: [
      { id: 1, text: "Biển 1 và biển 3.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !0 },
      { id: 3, text: "Biển 3.", correct: !1 },
    ],
    topic: 5,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Biển 3.", correct: !0 },
      { id: 4, text: "Biển 1 và biển 2.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Biển 3.", correct: !1 },
      { id: 4, text: "Không biển nào.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo trước đoạn đường có gió ngang.", correct: !1 },
      { id: 2, text: "Báo trước đoạn đường trơn trượt.", correct: !1 },
      { id: 3, text: "Báo trước sắp đến bến phà.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo hiệu đường có ổ gà, lồi lõm.", correct: !0 },
      { id: 2, text: "Báo hiệu đường có gồ giảm tốc phía trước.", correct: !1 },
    ],
    topic: 5,
    a1: 186,
    a2: 186,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Báo hiệu đường có ổ gà, lồi lõm.", correct: !1 },
      { id: 2, text: "Báo hiệu đường có gồ giảm tốc phía trước.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1.", correct: !1 },
      { id: 2, text: "Biển 2.", correct: !1 },
      { id: 3, text: "Không biển nào.", correct: !0 },
    ],
    topic: 5,
    a1: 191,
    a2: 191,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Biển hạn chế tốc độ tối đa trong khu vực.", correct: !0 },
      {
        id: 4,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 1 và 2.", correct: !0 },
      { id: 2, text: "Cả ba biển.", correct: !1 },
      { id: 3, text: "Không biển nào.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đỗ xe hoàn toàn trên hè phố.", correct: !1 },
      { id: 2, text: "Đỗ xe hoàn toàn dưới lòng đường.", correct: !1 },
      { id: 3, text: "Đỗ từ 1/2 thân xe trở lên trên hè phố.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Bắt buộc.", correct: !0 },
      { id: 2, text: "Không bắt buộc.", correct: !1 },
    ],
    topic: 5,
    a1: 206,
    a2: 206,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Biển 2 và biển 3.", correct: !1 },
      { id: 2, text: "Biển 1 và biển 2.", correct: !1 },
      { id: 3, text: "Biển 1 và biển 3.", correct: !0 },
      { id: 4, text: "Cả ba biển.", correct: !1 },
    ],
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đi thẳng hoặc rẽ trái trên cầu vượt.", correct: !1 },
      { id: 2, text: "Đi thẳng hoặc rẽ phải trên cầu vượt.", correct: !1 },
      { id: 3, text: "Báo hiệu cầu vượt liên thông.", correct: !0 },
    ],
    topic: 5,
    a1: 208,
    a2: 208,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Báo hiệu đường cụt phía trước.", correct: !1 },
      { id: 3, text: "Báo hiệu nút giao gần nhất phía trước.", correct: !1 },
      { id: 4, text: "Báo hiệu trạm dừng nghỉ phía trước.", correct: !1 },
    ],
    topic: 5,
    a1: 210,
    a2: 210,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được phép chuyển sang làn khác.", correct: !0 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ dẫn sắp đến vị trí nhập làn xe.", correct: !1 },
      { id: 2, text: "Chỉ dẫn vị trí nhập làn xe cách 250 m.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Bắt đầu đường cao tốc.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Xăng dầu, ăn uống, nhà nghỉ, sửa chữa xe.", correct: !1 },
      { id: 3, text: "Xăng dầu, ăn uống, cấp cứu, sửa chữa xe.", correct: !1 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ dẫn đến trạm kiểm tra tải trọng xe.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Vạch 1.", correct: !1 },
      { id: 2, text: "Vạch 2 và vạch 3.", correct: !1 },
      { id: 3, text: "Vạch 3.", correct: !0 },
      { id: 4, text: "Vạch 1 và vạch 2.", correct: !1 },
    ],
    topic: 5,
    a1: 214,
    a2: 214,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Vạch 1.", correct: !1 },
      { id: 2, text: "Vạch 2.", correct: !1 },
      { id: 3, text: "Vạch 3.", correct: !1 },
      { id: 4, text: "Vạch 1 và vạch 2.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Vạch 1.", correct: !1 },
      { id: 2, text: "Vạch 2.", correct: !0 },
      { id: 3, text: "Vạch 3.", correct: !1 },
      { id: 4, text: "Cả ba vạch.", correct: !1 },
    ],
    topic: 5,
    a1: 215,
    a2: 215,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Vạch 2.", correct: !1 },
      { id: 3, text: "Vạch 3.", correct: !1 },
      { id: 4, text: "Vạch 1 và vạch 3.", correct: !0 },
    ],
    topic: 5,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Để xác định làn đường.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe tải, xe mô tô.", correct: !1 },
      { id: 2, text: "Xe tải, xe mô tô.", correct: !1 },
      { id: 3, text: "Chỉ xe con.", correct: !0 },
    ],
    topic: 6,
    a1: 216,
    a2: 216,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải, xe khách, xe con, xe mô tô.", correct: !1 },
      { id: 2, text: "Xe tải, xe mô tô, xe khách, xe con.", correct: !0 },
      { id: 3, text: "Xe khách, xe tải, xe con, xe mô tô.", correct: !1 },
      { id: 4, text: "Xe mô tô, xe khách, xe tải, xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 217,
    a2: 217,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải, xe con, xe mô tô.", correct: !1 },
      { id: 2, text: "Xe con, xe tải, xe mô tô.", correct: !1 },
      { id: 3, text: "Xe mô tô, xe con, xe tải.", correct: !0 },
      { id: 4, text: "Xe con, xe mô tô, xe tải.", correct: !1 },
    ],
    topic: 6,
    a1: 218,
    a2: 218,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con.", correct: !0 },
      { id: 2, text: "Xe tải.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe mô tô.", correct: !1 },
      { id: 2, text: "Xe con.", correct: !0 },
    ],
    topic: 6,
    a1: 219,
    a2: 219,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe mô tô.", correct: !1 },
      { id: 2, text: "Xe cứu thương đi làm nhiệm vụ cấp cứu.", correct: !0 },
    ],
    topic: 6,
    a1: 220,
    a2: 220,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách.", correct: !0 },
      { id: 2, text: "Xe tải.", correct: !1 },
      { id: 3, text: "Xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe công an đi làm nhiệm vụ khẩn cấp.", correct: !1 },
      { id: 2, text: "Xe chữa cháy đi làm nhiệm vụ chữa cháy.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con và xe khách.", correct: !0 },
      { id: 2, text: "Xe mô tô.", correct: !1 },
    ],
    topic: 6,
    a1: 221,
    a2: 221,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe mô tô.", correct: !1 },
      { id: 2, text: "Xe con, xe tải.", correct: !0 },
      { id: 3, text: "Xe tải, xe mô tô.", correct: !1 },
    ],
    topic: 6,
    a1: 222,
    a2: 222,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe công an đi làm nhiệm vụ khẩn cấp.", correct: !1 },
      { id: 2, text: "Xe quân sự đi làm nhiệm vụ khẩn cấp.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hướng 2, 3, 4.", correct: !1 },
      { id: 2, text: "Chỉ hướng 1.", correct: !0 },
      { id: 3, text: "Hướng 1 và 2.", correct: !1 },
      { id: 4, text: "Hướng 3 và 4.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe tải, xe mô tô.", correct: !0 },
      { id: 2, text: "Xe tải, xe con, xe mô tô.", correct: !1 },
      { id: 3, text: "Xe khách, xe con, xe mô tô.", correct: !1 },
    ],
    topic: 6,
    a1: 223,
    a2: 223,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe tải, xe mô tô, xe con.", correct: !1 },
      { id: 2, text: "Xe con, xe khách, xe tải, xe mô tô.", correct: !1 },
      { id: 3, text: "Xe mô tô, xe tải, xe khách, xe con.", correct: !0 },
      { id: 4, text: "Xe mô tô, xe tải, xe con, xe khách.", correct: !1 },
    ],
    topic: 6,
    a1: 224,
    a2: 224,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải.", correct: !0 },
      { id: 2, text: "Xe con và mô tô.", correct: !1 },
      { id: 3, text: "Cả ba xe.", correct: !1 },
      { id: 4, text: "Xe con và xe tải.", correct: !1 },
    ],
    topic: 6,
    a1: 225,
    a2: 225,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải.", correct: !1 },
      { id: 2, text: "Xe con (B).", correct: !0 },
      { id: 3, text: "Xe con (A).", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả ba hướng.", correct: !0 },
      { id: 2, text: "Chỉ hướng 1 và 3.", correct: !1 },
      { id: 3, text: "Chỉ hướng 1.", correct: !1 },
    ],
    topic: 6,
    a1: 226,
    a2: 226,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả hai xe.", correct: !0 },
      { id: 2, text: "Không xe nào vi phạm.", correct: !1 },
      { id: 3, text: "Chỉ xe mô tô vi phạm.", correct: !1 },
      { id: 4, text: "Chỉ xe tải vi phạm.", correct: !1 },
    ],
    topic: 6,
    a1: 227,
    a2: 227,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ xe mô tô.", correct: !1 },
      { id: 2, text: "Chỉ xe tải.", correct: !1 },
      { id: 3, text: "Cả ba xe.", correct: !0 },
      { id: 4, text: "Chỉ xe mô tô và xe tải.", correct: !1 },
    ],
    topic: 6,
    a1: 228,
    a2: 228,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đúng.", correct: !1 },
      { id: 2, text: "Không đúng.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hướng 2 và 5.", correct: !1 },
      { id: 2, text: "Chỉ hướng 1.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hướng 1 và 2.", correct: !1 },
      { id: 2, text: "Hướng 3.", correct: !0 },
      { id: 3, text: "Hướng 1 và 4.", correct: !1 },
      { id: 4, text: "Hướng 2 và 3.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả hai xe đều đúng.", correct: !0 },
      { id: 2, text: "Xe con.", correct: !1 },
      { id: 3, text: "Xe khách.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hướng 2 và 3.", correct: !0 },
      { id: 2, text: "Hướng 1, 2 và 3.", correct: !1 },
      { id: 3, text: "Hướng 1 và 3.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không.", correct: !1 },
      { id: 2, text: "Vi phạm.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con.", correct: !1 },
      { id: 2, text: "Xe mô tô.", correct: !0 },
    ],
    topic: 6,
    a1: 229,
    a2: 229,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không đúng.", correct: !0 },
      { id: 2, text: "Đúng.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hướng 1.", correct: !1 },
      { id: 2, text: "Hướng 1, 3 và 4.", correct: !0 },
      { id: 3, text: "Hướng 2, 3 và 4.", correct: !1 },
      { id: 4, text: "Cả bốn hướng.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con (A), xe mô tô, xe con (B), xe đạp.", correct: !1 },
      { id: 2, text: "Xe con (B), xe đạp, xe mô tô, xe con (A).", correct: !1 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ hướng 1.", correct: !0 },
      { id: 2, text: "Hướng 1, 3 và 4.", correct: !1 },
      { id: 3, text: "Hướng 1, 2 và 3.", correct: !1 },
      { id: 4, text: "Cả bốn hướng.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả ba hướng.", correct: !1 },
      { id: 2, text: "Hướng 2 và 3.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ hướng 1.", correct: !1 },
      { id: 2, text: "Hướng 1 và 4.", correct: !1 },
      { id: 3, text: "Hướng 1 và 5.", correct: !0 },
      { id: 4, text: "Hướng 1, 4 và 5.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả bốn hướng.", correct: !1 },
      { id: 2, text: "Trừ hướng 2.", correct: !0 },
      { id: 3, text: "Hướng 2, 3 và 4.", correct: !1 },
      { id: 4, text: "Trừ hướng 4.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Không vi phạm.", correct: !1 },
      { id: 2, text: "Vi phạm.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách.", correct: !1 },
      { id: 2, text: "Xe mô tô.", correct: !1 },
      { id: 3, text: "Xe con.", correct: !0 },
      { id: 4, text: "Xe con và xe mô tô.", correct: !1 },
    ],
    topic: 6,
    a1: 232,
    a2: 232,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe mô tô, xe con.", correct: !1 },
      { id: 2, text: "Xe con, xe tải.", correct: !1 },
      { id: 3, text: "Xe mô tô, xe tải.", correct: !0 },
      { id: 4, text: "Cả ba xe.", correct: !1 },
    ],
    topic: 6,
    a1: 234,
    a2: 234,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đúng.", correct: !0 },
      { id: 2, text: "Không đúng.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe chữa cháy đi làm nhiệm vụ chữa cháy.", correct: !1 },
      { id: 2, text: "Xe tải.", correct: !0 },
      { id: 3, text: "Cả hai xe.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe tải, xe con.", correct: !1 },
      { id: 2, text: "Xe con, xe tải, xe khách.", correct: !1 },
      { id: 3, text: "Xe tải, xe khách, xe con.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách và xe tải, xe con.", correct: !0 },
      { id: 2, text: "Xe tải, xe khách, xe con.", correct: !1 },
      { id: 3, text: "Xe con, xe khách, xe tải.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả bốn hướng.", correct: !1 },
      { id: 2, text: "Chỉ hướng 1 và 2.", correct: !1 },
      { id: 3, text: "Trừ hướng 4.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Hướng 1, 2 và 3.", correct: !1 },
      { id: 3, text: "Hướng 1 và 4.", correct: !1 },
      { id: 4, text: "Hướng 1, 3 và 4.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ xe khách, xe mô tô.", correct: !1 },
      { id: 2, text: "Tất cả các loại xe trên.", correct: !0 },
      {
        id: 3,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Cả ba hướng.", correct: !1 },
      { id: 2, text: "Hướng 1 và 2.", correct: !1 },
      { id: 3, text: "Hướng 1 và 3.", correct: !0 },
      { id: 4, text: "Hướng 2 và 3.", correct: !1 },
    ],
    topic: 6,
    a1: 236,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe A.", correct: !0 },
      { id: 2, text: "Xe B.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con (E), xe mô tô (C).", correct: !0 },
      { id: 2, text: "Xe tải (A), xe mô tô (D).", correct: !1 },
      { id: 3, text: "Xe khách (B), xe mô tô (C).", correct: !1 },
      { id: 4, text: "Xe khách (B), xe mô tô (D).", correct: !1 },
    ],
    topic: 6,
    a1: 238,
    a2: 238,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Nhường xe con rẽ trái trước.", correct: !0 },
      { id: 2, text: "Đi thẳng không nhường.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Chỉ hướng 2.", correct: !1 },
      { id: 2, text: "Hướng 1 và 2.", correct: !0 },
      { id: 3, text: "Tất cả các hướng trừ hướng 3.", correct: !1 },
      { id: 4, text: "Tất cả các hướng trừ hướng 4.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Rẽ trái ngay trước xe buýt.", correct: !1 },
      { id: 2, text: "Rẽ trái trước xe tải.", correct: !1 },
      { id: 3, text: "Nhường đường cho xe buýt và xe tải.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con (B), xe mô tô (C).", correct: !1 },
      { id: 2, text: "Xe con (A), xe mô tô (C).", correct: !1 },
      { id: 3, text: "Xe con (E), xe mô tô (D).", correct: !0 },
      { id: 4, text: "Tất cả các loại xe trên.", correct: !1 },
    ],
    topic: 6,
    a1: 239,
    a2: 239,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe của bạn.", correct: !1 },
      { id: 2, text: "Xe tải.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Quay đầu theo hướng A.", correct: !0 },
      { id: 2, text: "Quay đầu theo hướng B.", correct: !1 },
      { id: 3, text: "Cấm quay đầu.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con và xe tải, xe của bạn.", correct: !1 },
      { id: 2, text: "Xe của bạn, xe tải, xe con.", correct: !1 },
      { id: 3, text: "Xe của bạn và xe con, xe tải.", correct: !0 },
      { id: 4, text: "Xe của bạn, xe tải + xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Tăng tốc cho xe chạy vượt qua.", correct: !1 },
      {
        id: 2,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe mô tô.", correct: !1 },
      { id: 2, text: "Xe tải, xe mô tô.", correct: !1 },
      { id: 3, text: "Xe con, xe tải.", correct: !0 },
    ],
    topic: 6,
    a1: 240,
    a2: 240,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải ( D), xe con (B).", correct: !1 },
      {
        id: 2,
        text: "Xe con (A), xe con (C), xe con (E), xe buýt (G).",
        correct: !0,
      },
      { id: 3, text: "Xe con (A), xe con (B), xe tải (D).", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được vượt.", correct: !1 },
      { id: 2, text: "Cấm vượt.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    tip: "Tại nơi giao nhau, trên đoạn đường có làn đường dành cho người đi bộ cắt ngang thì không được phép vượt.",
    answers: [
      { id: 1, text: "Cho phép.", correct: !1 },
      { id: 2, text: "Không được vượt.", correct: !0 },
    ],
    topic: 6,
    a1: 241,
    a2: 241,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Vị trí A và B.", correct: !1 },
      { id: 2, text: "Vị trí A và C.", correct: !1 },
      { id: 3, text: "Vị trí B và C.", correct: !0 },
      { id: 4, text: "Cả ba vị trí A, B, C.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Được phép dừng ở vị trí A.", correct: !1 },
      { id: 2, text: "Được phép dừng ở vị trí B.", correct: !1 },
      { id: 3, text: "Được phép dừng ở vị trí A và B.", correct: !1 },
      { id: 4, text: "Không được dừng.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe mô tô.", correct: !1 },
      { id: 2, text: "Xe ô tô con.", correct: !1 },
      { id: 3, text: "Không xe nào vi phạm.", correct: !1 },
      { id: 4, text: "Cả hai xe.", correct: !0 },
    ],
    topic: 6,
    a1: 242,
    a2: 242,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con.", correct: !1 },
      { id: 2, text: "Xe tải.", correct: !0 },
      { id: 3, text: "Xe con, xe tải.", correct: !1 },
    ],
    topic: 6,
    a1: 243,
    a2: 243,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải, xe con.", correct: !1 },
      { id: 2, text: "Xe khách, xe con.", correct: !1 },
      { id: 3, text: "Xe khách, xe tải.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con, xe tải, xe khách.", correct: !1 },
      { id: 2, text: "Xe tải, xe khách, xe mô tô.", correct: !0 },
      { id: 3, text: "Xe khách, xe mô tô, xe con.", correct: !1 },
      { id: 4, text: "Cả bốn xe.", correct: !1 },
    ],
    topic: 6,
    a1: 244,
    a2: 244,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe khách, xe tải.", correct: !0 },
      { id: 2, text: "Xe khách, xe con.", correct: !1 },
      { id: 3, text: "Xe con, xe tải.", correct: !1 },
      { id: 4, text: "Xe khách, xe tải, xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải, xe mô tô.", correct: !1 },
      { id: 2, text: "Xe khách, xe mô tô.", correct: !0 },
      { id: 3, text: "Xe tải, xe con.", correct: !1 },
      { id: 4, text: "Xe mô tô, xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 245,
    a2: 245,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con (A), xe con (B), xe tải (D).", correct: !1 },
      { id: 2, text: "Xe tải (D), xe con (E), xe buýt (G).", correct: !1 },
      { id: 3, text: "Xe tải ( D), xe con (B).", correct: !0 },
      { id: 4, text: "Xe con (B), xe con (C).", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe của bạn, xe mô tô, xe con.", correct: !1 },
      { id: 2, text: "Xe con, xe của bạn, xe mô tô.", correct: !1 },
      { id: 3, text: "Xe mô tô, xe con, xe của bạn.", correct: !0 },
    ],
    topic: 6,
    a1: 246,
    a2: 246,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe của bạn, xe mô tô, xe con.", correct: !1 },
      { id: 2, text: "Xe con, xe của bạn, xe mô tô.", correct: !0 },
      { id: 3, text: "Xe mô tô, xe con, xe của bạn.", correct: !1 },
    ],
    topic: 6,
    a1: 247,
    a2: 247,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con.", correct: !0 },
      { id: 2, text: "Xe của bạn.", correct: !1 },
      { id: 3, text: "Cả hai xe.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Đi thẳng, rẽ trái.", correct: !0 },
      { id: 2, text: "Đi thẳng, rẽ phải.", correct: !1 },
      { id: 3, text: "Rẽ trái.", correct: !1 },
      { id: 4, text: "Đi thẳng, rẽ phải, rẽ trái.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Tăng tốc độ, rẽ phải trước xe đạp.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 3, text: "Nhường đường cho xe đạp và xe khách.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con.", correct: !1 },
      { id: 2, text: "Xe tải.", correct: !0 },
      { id: 3, text: "Xe của bạn.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe đi ngược chiều.", correct: !1 },
      { id: 2, text: "Xe của bạn.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Không được vượt những người đi xe đạp.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 2, text: "Bấm còi, nháy đèn báo hiệu và đi tiếp.", correct: !1 },
      { id: 3, text: "Giảm tốc độ, dừng lại nhường đường.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Tăng tốc độ và đi thẳng qua ngã tư.", correct: !1 },
      { id: 2, text: "Dừng xe trước vạch dừng.", correct: !1 },
      { id: 3, text: "Giảm tốc độ và đi thẳng qua ngã tư.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe của bạn, xe mô tô, xe đạp.", correct: !1 },
      { id: 2, text: "Xe mô tô, xe đạp, xe của bạn.", correct: !1 },
      { id: 3, text: "Xe đạp, xe mô tô, xe của bạn.", correct: !0 },
    ],
    topic: 6,
    a1: 248,
    a2: 248,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe của bạn, xe tải, xe con.", correct: !1 },
      { id: 2, text: "Xe con, xe tải, xe của bạn.", correct: !1 },
      { id: 3, text: "Xe tải, xe của bạn, xe con.", correct: !1 },
      { id: 4, text: "Xe của bạn, xe con, xe tải.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe của bạn.", correct: !0 },
      { id: 2, text: "Xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con, xe tải, xe của bạn.", correct: !1 },
      { id: 2, text: "Xe tải, xe con, xe của bạn.", correct: !0 },
      { id: 3, text: "Xe tải, xe của bạn, xe con.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe con.", correct: !0 },
      { id: 2, text: "Xe mô tô.", correct: !1 },
      { id: 3, text: "Cả 2 xe đều đúng.", correct: !1 },
    ],
    topic: 6,
    a1: 249,
    a2: 249,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Xe tải, xe đạp, xe của bạn.", correct: !1 },
      { id: 2, text: "Xe của bạn, xe đạp, xe tải.", correct: !1 },
      { id: 3, text: "Xe của bạn, xe tải, xe đạp.", correct: !0 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Hướng 1.", correct: !0 },
      { id: 2, text: "Hướng 2.", correct: !1 },
      { id: 3, text: "Cả hai hướng đều được.", correct: !1 },
    ],
    topic: 6,
    a1: 0,
    a2: 0,
  ...
  },
  {
    ...
    answers: [
      { id: 1, text: "Vượt về phía bên phải để đi tiếp.", correct: !1 },
      {
        id: 2,
        text: "Giảm tốc độ chờ xe container rẽ xong rồi tiếp tục đi.",
        correct: !0,
      },
      { id: 3, text: "Vượt về phía bên trái để đi tiếp.", correct: !1 },
    ],
    topic: 6,
    a1: 250,
    a2: 250,
...
var licenseType = "B_2025",
  getRequiredFilter = function (n) {
    return "A1_2025" === n || "A_2025" === n
      ? function (n) {
          return n.required1 > 0;
        }
      : "B1_2025" === n
        ? function (n) {
            return n.required2 > 0;
          }
        : function (n) {
            return n.required3 > 0;
          };
  },
  fullQuestions = originalQuestions,
  filterRequiredFunction = getRequiredFilter(licenseType),
